...
avgdmgpm = float(output['Avg Dmg per Match'])
json_AVG_DMG_PER_MATCH = [
        {
            "measurement": "AVG_DMG_PER_MATCH",
            "tags": {
                "Player": "AnalSod0my"
                },
            "time" : current_time,
...
client.write_points(json_AVG_DMG_PER_MATCH)
...
print('\n Rating:', rating)
print('\n Average Damage Per Match:', avgdmgpm)
