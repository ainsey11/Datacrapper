...
$admin_email = 'admin@ainsey11.com';

//EMAIL SETTINGS
//SEND TEST EMAILS THROUGH FORM TO https://www.mail-tester.com GENERATED ADDRESS FOR SPAM SCORE
$from_email = 'datacrapper@ainsey11/com'; //Webmaster email
$from_name = 'Datacrapper Control'; //"From name" displayed on email

//Find specific server settings at https://www.arclab.com/en/kb/email/list-of-smtp-and-pop3-servers-mailserver-list.html
$mailServerType = 'smtp';
//IF $mailServerType = 'smtp'
$smtp_server = 'localhost';
$smtp_user = 'datacrapper';
$smtp_pw = 'datacrapper';
...
$signupthanks = 'Thank you for signing up! You will receive an email shortly confirming the verification of your account. `n `n Please check your spam e-mail folder for verification link';
